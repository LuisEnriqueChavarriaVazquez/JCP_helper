...
let boxContainerPopUp = document.getElementById('popUpThemes');

//El fondo con la imagen del perfil
let fondoDinamicoUsuario = document.getElementById('fondoDinamicoUsuario');
