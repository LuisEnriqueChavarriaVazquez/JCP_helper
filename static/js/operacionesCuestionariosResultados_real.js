...
function imprimirPreguntas() {
        ...
        if (validacion == true) {
            ...
            for (var m = 0; m < preguntasModalArray1.length - 1; m++) {
                ...
                <div class="opcionesContainerStyleViewCuestionario">
                    <div class="color5 bordered5 colorTextReverse letterStyleViewCuestionario">A</div><div class="colorGrey bordered1 colorTextReverse opcionStyleViewCuestionario">` + preguntasModalArray1[m][3] + `</div>
                    <div class="color5 bordered5 colorTextReverse letterStyleViewCuestionario">B</div><div class="colorGrey bordered1 colorTextReverse opcionStyleViewCuestionario">` + preguntasModalArray1[m][4] + `</div>
                    <div class="color5 bordered5 colorTextReverse letterStyleViewCuestionario">C</div><div class="colorGrey bordered1 colorTextReverse opcionStyleViewCuestionario">` + preguntasModalArray1[m][5] + `</div>
                    <div class="color5 bordered5 colorTextReverse letterStyleViewCuestionario">D</div><div class="colorGrey bordered1 colorTextReverse opcionStyleViewCuestionario">` + preguntasModalArray1[m][6] + `</div>
                    </div>
                    <section class="colorGrey bordered1 shadow-1e respuestaFinalBoxes">
                        <h6 class="colorTextReverse"><b>Solution.</b></h6>
                        ...
                        <h6 class="colorTextReverse"><b>Res.</b></h6>
    ...
    function ingresarPreguntasAcompletar() {
        ...
        if (validacion == true) {
            ...
            <div class="ponderacionBox colorTextReverse ponderacion_opt2 colorWhite bordered1"></div>`;
    ...
    function ingresarPreguntasEjercicios() {
        ...
        if (validacion == true) {
            ...
            <hr>
            <div class="preguntaBox colorGrey colorTextReverse bordered1"><b>` + preguntasModalArray3[k][0] + `</b></div>
            <div class="imagenBox bordered1 shadow-1e colorGrey">
            <h6 class="colorTextReverse"><b>Img.</b></h6>
            <img alt='not available image' class="materialboxed imagenBoxContent bordered1" src="` + preguntasModalArray3[k][1] + `"></img>
            </div>
            <section class="colorGrey bordered1 shadow-1e respuestaFinalBoxes">
                <h6 class="colorTextReverse"><b>Teacher's solution.</b></h6>
                <div class="codeContainerBox"><pre class="previewCodeContainer colorText bordered1">` + preguntasModalArray3[k][3] + `</pre></div>
                <div class="preguntaBox outputEsperado colorTextReverse outputGetValue color5 bordered1"><b>Output: ` + preguntasModalArray3[k][4] + `</b></div>
                <h6 class="tituloEjercicioPendiente colorTextReverse"><b>Res.</b></h6>
    ...
    function ingresarPreguntasArrastrar() {
        ...
        if (validacion == true) {
            ...
            <hr>
            <div class="preguntaBox colorTextReverse colorGrey bordered1"><b>` + preguntasModalArray4[numero][0] + `</b></div>
            <h6 class="colorTextReverse"><b>Correct relation.</b></h6>
            ...
            <section class="colorGrey bordered1 shadow-1e respuestaFinalBoxes">
                <h6 class="colorTextReverse"><b>Solution.</b></h6>
                <p>The points are divide by the total, if one is wrong all is wrong</p>
    ...
    function ingresarPreguntasTrueFalse() {
        ...
        if (validacion == true) {
            ...
            for (var m = 0; m < preguntasModalArray5.length - 1; m++) {
                ...
                <hr>
                <div class="preguntaBox colorGrey bordered1 colorTextReverse"><b>` + preguntasModalArray5[m][0] + `</b></div>
                <section class="colorGrey bordered1 shadow-1e respuestaFinalBoxes">
                    <h6 class="colorTextReverse"><b>Solution.</b></h6>
                    <div class="opcionesContainerStyleViewCuestionarioTrueFalse">
                    <div class="preguntaBoxFalseTrue color5 colorTextReverse bordered1"><b>` + preguntasModalArray5[m][1] + `</b></div>
                    </div>
                    <h6 class="colorTextReverse"><b>Res.</b></h6>
    ...
    function ingresarPreguntasAbiertas() {
        ...
        if (validacion == true) {
            ...
            <hr>
                ...
                <section class="colorGrey bordered1 shadow-1e respuestaFinalBoxes">
                    <h6 class="colorTextReverse"><b>Solution.</b></h6>
                    <div class="preguntaBox outputEsperado colorTextReverse colorGreyDarker bordered1">
                        <b>
                    ...
                    <div class="ponderacionBox colorTextReverse ponderacion_opt6 colorWhite bordered1"></div>
                </section>
                `;
                contenedoresPregunta[m].innerHTML = contenido;
            }
            ...
            for (var f = 0; f < Object.values(respuestasUsuarioTotal[r]).length; f++) {
                ...
                */
                if (Object.values(resultadosProfeTotal[r]).length != Object.values(respuestasUsuarioTotal[r]).length) {
                    ...
                    countAnswerBox[r].innerText = contadorIncorrectas + " Bad";
                    countAnswerBoxRight[r].innerText = contadorCorrectas + " Good " + valorPonderacionOpt4 + "pts.";
    ...
    function calcularPromedio() {
        ...
        if (rightAnswerOpt6.length > 0 || opt3Pendiente.length > 0) {
            ...
            calificacionContainer[0].innerHTML = "<p>Result pending. 🕑</p>";
        } else {
            var promedio = (ponderacionGlobal.toFixed(2) * 10) / ponderacionGlobalDada;
            calificacionContainer[0].innerHTML = "<p>Result: <span id='calificacionDataGet'>" + promedio.toFixed(2) + "</span></p>";
        }
    }
    calcularPromedio();
